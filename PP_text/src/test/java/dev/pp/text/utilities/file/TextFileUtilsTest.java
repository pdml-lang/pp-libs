...
public class TextFileUtilsTest {
    ...
    public void testGetNthLineInFile() throws IOException {
        ...
        File file = TempFileUtils.createNonEmptyTempTextFile ( "line 1\r\nline 2\n\nline 4\n", true );

        assertEquals ( "line 1", TextFileUtils.getNthLineInFile ( file, 1 ) );
        assertEquals ( "line 2", TextFileUtils.getNthLineInFile ( file, 2 ) );
        assertEquals ( "", TextFileUtils.getNthLineInFile ( file, 3 ) );
        assertEquals ( "line 4", TextFileUtils.getNthLineInFile ( file, 4 ) );
