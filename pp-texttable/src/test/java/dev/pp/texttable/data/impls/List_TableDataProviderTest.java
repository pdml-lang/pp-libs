...
class List_TableDataProviderTest {
    ...
    void test() {
        ...
        rows.add ( new TextLocation ( Path.of ( "foo.txt"), 1, 2, null ) );
        rows.add ( new TextLocation ( Path.of ( "bar.txt"), 11, 22, null ) );
        ...
        columns.add ( TableDataProviderUtilities.createTableDataColumn (
            "File", (textLocation) -> textLocation.getResourceAsFilePath ().toString() ) );
        columns.add ( TableDataProviderUtilities.createTableDataColumn (
